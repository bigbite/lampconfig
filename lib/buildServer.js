...
module.exports = () => {
  ...
  .then(() => runCommand({
    ...
    cmd: `sudo sed -i "s/listen =.*/listen = 127.0.0.1:9000/" /etc/php/${PHP_VERSION}/fpm/pool.d/www.conf && sudo sed -i "s/;listen.allowed_clients/listen.allowed_clients/" /etc/php/${PHP_VERSION}/fpm/pool.d/www.conf && sudo service php7.0-fpm restart`,
