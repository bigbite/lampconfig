...
module.exports = (store) => {
  ...
  .then(() => runCommand({
    loader: 'Enabling support MPM Worker, Rewrite, Actions and SSL...',
    cmd: `a2enmod mpm_worker rewrite actions ssl`,
    success: 'Support enabled for MPM Worker, Rewrite, Actions and SSL.'
  }))
  .then(() => runCommand({
